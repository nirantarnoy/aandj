...
/* @var $searchModel backend\models\ProdissueSearch */
...
<div class="prodissue-index">
    ...
    <div class="panel panel-headline">
        <div class="panel-heading">
            <div class="btn-group">
                <?= Html::a(Yii::t('app', '<i class="fa fa-plus"></i> สร้างใบเบิกวัตถุดิบ'), ['create'], ['class' => 'btn btn-success']) ?>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="pull-right">
                        <form id="form-perpage" class="form-inline" action="<?=Url::to(['prodissue/index'],true)?>" method="post">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'html',
                'value'=>function($data){
                    return $data->status === 1 ? '<div class="label label-success">Completed</div>':'<div class="label label-default">Cancel</div>';
                }
            ],
            [
