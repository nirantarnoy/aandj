				...
				<div class="auth-box ">
						<div class="content">
                            <div style="padding-left: 30%;padding-right: 30%;">
                                <div class="header">
                                    <div class="logo text-center"><img src="img/aj.png" alt="Klorofil Logo"></div>
                                    <br>
                                    <p class="lead" style="font-family: Cloud-Light;font-size: 24px;">ลงชื่อเข้าใช้งานระบบ</p>
                                </div>
                                <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>

                                <?= $form->field($model, 'username')->textInput(['autofocus' => true,'placeholder'=>'ชื่อผู้ใช้งาน','style'=>'font-family: Cloud-Light;font-size: 18px;'])->label(false) ?>
                                ...
                                <?php //echo $form->field($model, 'captcha')->widget(Captcha::className())->label(false) ?>
