...
<div class="prodrec-form">
    <div class="panel panel-headlin">
        <div class="panel-heading">
            <h3><i class="fa fa-files-o"></i> <?= $this->title ?>
                <small></small>
            </h3>
                ...
                <div class="col-lg-12">
                    <table class="table table-line">
                        ...
                        <?php if ($model->isNewRecord): ?>
                            <tr>
                                <td>
                                    <select name="product_id[]" onchange="checkzone($(this));"
                                            class="form-control line_product" id=""
                                ...
                                <td>
                                    ...
                                    <input readonly id="task-1" class="line_zone_id" type="hidden" name="line_zone_id[]"
                                           style="border: none;padding: 5px 5px 5px 5px;width: 100%;background:transparent;text-align: center"
                                           value="">
                                    <input readonly id="task-1" class="line_zone_qty" type="hidden"
                                           name="line_zone_qty[]"
                                           style="border: none;padding: 5px 5px 5px 5px;width: 100%;background:transparent;text-align: center"
                                           value="">
                                </td>
                                <td>
                                    <input readonly id="task-1" class="line_lot" type="text" name="line_lot[]"
                                           style="border: none;padding: 5px 5px 5px 5px;width: 100%;background:transparent;text-align: center"
                                           value="">
                                </td>
                                <td>
                                    <input id="task-1" class="line_qty" type="text" name="line_qty[]"
                                           style="border: none;padding: 5px 5px 5px 5px;width: 100%;background:transparent;text-align: center"
                                           value="" onchange="line_qty_change($(this))">

                                </td>
                                <td style="display: none;">
                                    <select name="line_orchard[]" class="form-control line_orchard" id=""
                                            style="border: none;padding: 5px 5px 5px 5px;width: 100%;background:transparent;text-align: center">
                                ...
                                <td style="display:none;">
                                    <select name="line_team[]" class="form-control line_team" id=""
                                            style="border: none;padding: 5px 5px 5px 5px;width: 100%;background:transparent;text-align: center">
                                ...
                                <td style="display:none;">
                                    <select name="line_transport_team[]" class="form-control line_transport_team" id=""
                                            style="border: none;padding: 5px 5px 5px 5px;width: 100%;background:transparent;text-align: center">
                                        <option value="">เลือกทีม</option>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="line_qc[]" class="line_qc"
                                           style="border: none;padding: 5px 5px 5px 5px;width: 100%;background:transparent;text-align: left"
                                           value="">
                                </td>
                                <td>
                                    <div class="btn btn-danger btn-sm btn-remove-line" onclick="removeline($(this))">
                                        ลบ
                                    </div>
                                </td>
                            </tr>
                            ...
                            <?php if (count($modelrecline) > 0): ?>
                                ...
                                <?php foreach ($modelrecline as $value): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input id="task-1" class="line_qty" onchange="line_qty_change($(this))"
                                                   type="text" name="line_qty[]"
                                                   style="border: none;padding: 5px 5px 5px 5px;width: 100%;background: transparent;text-align: center;"
                                                   value="<?= $value->qty ?>">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <select name="line_transport_team[]"
                                                    class="form-control line_transport_team" id=""
                                                    style="border: none;padding: 5px 5px 5px 5px;width: 100%;background:transparent;text-align: center">
                                                <option value="">เลือกทีมขน</option>
                                                <?php foreach ($modelteam2 as $data): ?>
                                                    <?php $select = '';
                                                    if ($data->id == $value->team2) {
                                                        $select = "selected";
                                                    } ?>
                                                    <option value="<?= $data->id ?>" <?= $select ?>><?= $data->name ?></option>
                                                <?php endforeach; ?>
            ...
            <div class="issue" style="display: none">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table class="table table-issue">
                            ...
                            <?php if (!$model->isNewRecord): ?>
                                <?php if (count($modelissue) > 0): ?>
                                    <?php foreach ($modelissue as $data): ?>
                                        <tr>
                                            <td>
                                                <select name="product_issue_id[]" onchange="checkzone($(this));"
                                                        class="form-control line_product" id=""
                                                        style="border: none;padding: 5px 5px 5px 5px;width: 100%;background:transparent;text-align: center">
                                                    <option value="">เลือกประเภท</option>
                                            ...
                                            <td>
                                                <input id="task-1" class="line_issue_qty" type="text"
                                                       name="line_issue_qty[]"
                                                       style="border: none;padding: 5px 5px 5px 5px;width: 100%;background:transparent;text-align: center"
                                                       value="<?= $data->qty ?>">
                                            </td>
                                            <td>
                                                <input id="task-1" class="line_issue_price" type="text"
                                                       name="line_issue_price[]"
                                                       style="border: none;padding: 5px 5px 5px 5px;width: 100%;background:transparent;text-align: center"
                                                       value="<?= $data->price ?>">
                                            </td>
                                            <td>
                                                <div class="btn btn-danger btn-sm btn-remove-line"
                                                     onclick="removelineissue($(this))">ลบ
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                            ...
                            <?php else: ?>
                                <tr>
                                    ...
                                    <td>
                                        <input id="task-1" class="line_issue_qty" type="text" name="line_issue_qty[]"
                                               style="border: none;padding: 5px 5px 5px 5px;width: 100%;background:transparent;text-align: center"
                                               value="">
                                    </td>
                                    <td>
                        ...
                        <?php if ($model->status < 2): ?>
                            <div class="btn btn-warning btn-add-issue"><i class="fa fa-plus-circle"></i> เพิ่มรายการเบิก
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-list-alt"></i> บันทึกคุณภาพ
   ...
   $(function(){
     ...
     // $(".line_zone").select2();
      ...
      $(".btn-add").click(function(){
              ...
              var $clone = $tr.clone();
              $clone.find(":text").val("");
            //  $clone.find(".line_zone").val("");
//              var x = $clone.find(".line_zone").attr("id");
//              alert(x);
//            var $select = $clone.find(\'.line_zone\').select2();
//
