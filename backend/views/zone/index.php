...
<div class="zone-index">
    ...
    <div class="panel panel-headline">
        <div class="panel-heading">
            <div class="btn-group">
                <?= Html::a(Yii::t('app', '<i class="fa fa-plus"></i> สร้างกอง'), ['create'], ['class' => 'btn btn-success']) ?>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="pull-right">
                        <form id="form-perpage" class="form-inline" action="<?=Url::to(['zone/index'],true)?>" method="post">
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'contentOptions' => ['style' => 'vertical-align: middle;text-align: right;'],
                            'value' => function($data){
                                $m = \backend\models\Zone::findProduction($data->id);
                                $wip = count($m)>0?$m->wip_qty:0;
                                return number_format($wip,0);
                            },
                        ],
                        [
                            'attribute'=>'remain_qty',
                            'label' => 'ค้างผลิต',
                            'headerOptions' => ['style'=>'text-align: right'],
                            'contentOptions' => ['style' => 'vertical-align: middle;text-align: right;'],
                            'value' => function($data){
                                $m = \backend\models\Zone::findProduction($data->id);
                                $remain = count($m)>0?$m->remain_qty:0;
                                return number_format($remain,0);
                            },
                        ],
                        [
                        ...
                        [
                            ...
                            'format' => 'html',
                            'value'=>function($data){
                                return $data->lock === 1 ? '<div class="label label-success">Yes</div>':'<div class="label label-default">No</div>';
                            }
                        ],
                        [
                            'attribute'=>'status',
