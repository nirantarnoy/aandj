...
/* @var $searchModel backend\models\WorkscheduleSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'ตารางตัดมะพร้าว');
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function($data){
                               $sttime = strtotime($data->trans_date);
                               return date('d-m-Y',$sttime);
                            }
                        ],
                        [
                            'attribute'=>'note',
                        ...
                        [
                            'attribute'=>'orchard_id',
                            'contentOptions' => ['style' => 'vertical-align: middle'],
                            'value'=>function($data){
                                return \backend\models\Orchard::getName($data->orchard_id);
                            }
                        ],
                        [
                            'attribute'=>'team_cut',
                            'contentOptions' => ['style' => 'vertical-align: middle'],
                            'value'=>function($data){
                                return \backend\models\Team::findName($data->team_cut);
                            }
                        ],
                        [
                            'attribute'=>'team_pick',
                            'contentOptions' => ['style' => 'vertical-align: middle'],
                            'value'=>function($data){
                                return \backend\models\Team::findName($data->team_pick);
                            }
                        ],
            //'team_pick',
            //'status',
