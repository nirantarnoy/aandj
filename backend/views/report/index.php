           ...
           <div class="row">
               <div class="col-lg-12">
                   <div class="list-group">
                       ...
                       <button type="button" class="list-group-item"><i class="fa fa-list-alt btn-print-summary"></i> รายงานสรุปจ่ายพ่อค้าลูกเขียว</button>
                       <button type="button" class="list-group-item"><i class="fa fa-list-alt btn-print-summary2"></i> รายงานสรุปจ่ายพ่อค้าลูกสำเร็จ</button>
    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form-print" action="<?=Url::to(['report/printsummary'],true)?>" method="post">
...
<div id="filterModal2" class="modal fade" role="dialog">
    <div class="modal-dialog modal-md">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <form id="form-print" action="<?=Url::to(['report/printsummary2'],true)?>" method="post">
                    <input type="hidden" name="line_qc_product" class="line_qc_product" value="">
                    <input type="hidden" name="line_qc_zone" class="line_qc_zone" value="">
                    <input type="hidden" name="line_qc_lot" class="line_qc_lot" value="">
                    <input type="hidden" name="line_qc_qty" class="line_qc_qty" value="">
...
$js=<<<JS
   $(function() {
      ...
      $(".btn-print-summary").click(function(){
       ...
       $(".btn-print-summary2").click(function(){
