...
$this->title = Yii::t('app', 'กลุ่มผู้ขาย');
  ...
  <?php $session = Yii::$app->session;
    ...
    <div class="panel panel-headline">
        <div class="panel-heading">
                    <div class="btn-group">
                      <?= Html::a(Yii::t('app', '<i class="fa fa-plus"></i> สร้างกลุ่มผู้ขาย'), ['create'], ['class' => 'btn btn-success']) ?>
                    </div>
                  ...
                  <div class="panel-body">
                        <div class="row">
                          ...
                          <div class="col-lg-3">
                            ...
                            <form id="form-perpage" class="form-inline" action="<?=Url::to(['supliergroup/index'],true)?>" method="post">
