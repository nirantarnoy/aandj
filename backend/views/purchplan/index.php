...
/* @var $searchModel backend\models\PurchplanSearch */
...
<div class="purchplan-index">
    ...
    if ($session->getFlash('msg') || $session->getFlash('error')): ?>
    <?php
        $type = $session->getFlash('msg')?'success':'error';
        $message = $session->getFlash('msg')?$session->getFlash('msg'):$session->getFlash('error');
    ?>
    ...
    <div class="panel panel-headline">
        <div class="panel-heading">
            ...
            <div class="btn-group">
                ...
                <a href="index.php?r=purchplan/showcalendar" class="btn btn-default btn-calendar"><i class="fa fa-calendar"></i> ปฏิทิน </a>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="pull-right">
                        <form id="form-perpage" class="form-inline" action="<?=Url::to(['purchplan/index'],true)?>" method="post">
...
$url_to_checkoldplan =  Url::to(['purchplan/checkoldplan'],true);
$this->registerJs('
    $(function(){
   ...
   function checkoldplan(e){
   e.preventDefault();
      $.ajax({
          dataType: "html",
          type:"post",
          url: "'.$url_to_checkoldplan.'",
          data: {},
          success: function(data){
            if(data == 1){
                swal({
                      title: "วันนี้กำหนดแผนไปแล้ว",
                      text: "",
                      type: "error",
