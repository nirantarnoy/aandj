...
class Vendor extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['vendor_group_id', 'status', 'created_at','buyer_id', 'iscompany','updated_at',
                'user_id','created_by', 'updated_by','vendor_type','payment_type','payment_term','delivery_type','lead_time'], 'integer'],
            [['name', 'description','vendor_code','id_card','tel'], 'string', 'max' => 255],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'tel'=> Yii::t('app', 'โทรศัพท์'),
            'iscompany' => Yii::t('app', 'ผู้ขายของบริษัท'),
